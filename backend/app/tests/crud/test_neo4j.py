...
from app.api_models_neo4j import LocationAPI, LocationsAPI, CourierAPI, AddLocationsRequest
...
def test_create_location():
    ...
    coordinates = [1.0, 1.0]
    location = crud.create_location(location_id=location_id, address=address, coordinates=coordinates)
...
def test_get_location_by_id():
    location_id = "1"
    test_location = crud.create_location(location_id=location_id, address="Test Address", coordinates=[1.0, 1.0])
